...
function Configurator($httpProvider, $stateProvider, $urlRouterProvider) {
  ...
  .state('account_info', {
      url: '/account/info',
      params : { username: null, email: null, country: null, city: null, phone: null },
      parent: 'app',
      views: {
          'account': {
  ...
  .state('account_edit', {
      url: '/account/edit',
      params : { username: null, gender: null, email: null, country: null, city: null, phone: null },
      parent: 'app',
      views: {
          'account': {
  ...
  .state('account_passchange', {
      url: '/account/changepass',
      parent: 'app',
      views: {
          'account': {
              templateUrl: 'templates/account.passchange.html',
              controller: 'AccountCtrl as account'
          }
      }
  })
